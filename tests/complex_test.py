...
complex_number_rectangular_examples = [
    ...
    ('\\variable{a}+\\imaginaryJ \\variable{b}', Add(get_variable_symbol('a'), Mul(I, get_variable_symbol('b'), evaluate=False), evaluate=False), {}),
...
complex_number_polar_examples = [
    ...
    # degrees w/ variables
    ('\\variable{a}\\angle \\variable{b}\\degree ', Mul(get_variable_symbol('a'), exp(Mul(I, Mul(get_variable_symbol('b'), Pow(180, -1, evaluate=False), pi, evaluate=False), evaluate=False), evaluate=False), evaluate=False), {}),
    ...
    ('\\variable{a}\\angle \\variable{b}', Mul(get_variable_symbol('a'), exp(Mul(I, Mul(get_variable_symbol('b'), evaluate=False), evaluate=False), evaluate=False), evaluate=False), {}),
