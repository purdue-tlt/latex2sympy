...
degC = degreesCelsius = degreeCelsius = Quantity('degreeCelsius', abbrev='degC', latex_repr=r'\degree C')

degF = degreesFahrenheit = degreeFahrenheit = Quantity('degreeFahrenheit', abbrev='degF', latex_repr=r'\degree F')
