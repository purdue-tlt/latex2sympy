...
enum LATEXLexerToken {
    ...
    FUNC_ARG_NAME = 97, FUNC_ABS_NAME = 98, CMD_TIMES = 99, CMD_CDOT = 100, 
    CMD_DIV = 101, CMD_FRAC = 102, CMD_BINOM = 103, CMD_CHOOSE = 104, CMD_MOD = 105, 
    CMD_MATHIT = 106, CMD_OPERATORNAME = 107, MATRIX_TYPE_MATRIX = 108, 
    MATRIX_TYPE_PMATRIX = 109, MATRIX_TYPE_BMATRIX = 110, MATRIX_TYPES = 111, 
    CMD_MATRIX_START = 112, CMD_MATRIX_END = 113, MATRIX_DEL_COL = 114, 
    MATRIX_DEL_ROW = 115, ACCENT_OVERLINE = 116, ACCENT_BAR = 117, LETTER = 118, 
    UNIT_SYMBOL = 119, NUMBER = 120, FRACTION_NUMBER = 121, SCI_NOTATION_NUMBER = 122, 
    E_NOTATION = 123, PERCENT_NUMBER = 124, GREEK_CMD = 125, EXP_E = 126, 
    DIFFERENTIAL_D = 127, SYMBOL = 128, VARIABLE = 129, COMPLEX_NUMBER_POLAR_ANGLE = 130
};
