...
enum LATEXLexerToken {
    ...
    MATRIX_DEL_ROW = 116, ACCENT_OVERLINE = 117, ACCENT_BAR = 118, EXP_E = 119, 
    LETTER = 120, DIFFERENTIAL = 121, LETTERS = 122, NUMBER = 123, FRACTION_NUMBER = 124, 
    SCI_NOTATION_NUMBER = 125, E_NOTATION = 126, PERCENT_NUMBER = 127, GREEK_CMD = 128, 
    SYMBOL = 129, VARIABLE = 130, COMPLEX_NUMBER_POLAR_ANGLE = 131
};
...
static const char* LATEXLexerTokenStrings[] = {
    ...
    "MATRIX_DEL_ROW", "ACCENT_OVERLINE", "ACCENT_BAR", "EXP_E", 
    "LETTER", "DIFFERENTIAL", "LETTERS", "NUMBER", "FRACTION_NUMBER", 
    "SCI_NOTATION_NUMBER", "E_NOTATION", "PERCENT_NUMBER", "GREEK_CMD", 
    "SYMBOL", "VARIABLE", "COMPLEX_NUMBER_POLAR_ANGLE"
};
