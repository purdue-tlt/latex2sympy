...
enum LATEXLexerToken {
    ...
    FUNC_MAX = 94, FUNC_MIN = 95, CMD_TIMES = 96, CMD_CDOT = 97, CMD_DIV = 98, 
    CMD_FRAC = 99, CMD_BINOM = 100, CMD_CHOOSE = 101, CMD_MOD = 102, CMD_MATHIT = 103, 
    CMD_OPERATORNAME = 104, MATRIX_TYPE_MATRIX = 105, MATRIX_TYPE_PMATRIX = 106, 
    MATRIX_TYPE_BMATRIX = 107, MATRIX_TYPES = 108, CMD_MATRIX_START = 109, 
    CMD_MATRIX_END = 110, MATRIX_DEL_COL = 111, MATRIX_DEL_ROW = 112, ACCENT_OVERLINE = 113, 
    ACCENT_BAR = 114, EXP_E = 115, E_NOTATION_E = 116, LETTER_NO_E = 117, 
    DIFFERENTIAL = 118, NUMBER = 119, FRACTION_NUMBER = 120, SCI_NOTATION_NUMBER = 121, 
    E_NOTATION = 122, PERCENT_NUMBER = 123, GREEK_CMD = 124, SYMBOL = 125, 
    VARIABLE = 126
};
...
static const char* LATEXLexerTokenStrings[] = {
    ...
    "ACCENT_BAR", "EXP_E", "E_NOTATION_E", "LETTER_NO_E", 
    "DIFFERENTIAL", "NUMBER", "FRACTION_NUMBER", "SCI_NOTATION_NUMBER", 
    "E_NOTATION", "PERCENT_NUMBER", "GREEK_CMD", "SYMBOL", 
    "VARIABLE"
};
