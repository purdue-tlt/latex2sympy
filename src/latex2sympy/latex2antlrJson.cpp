...
enum LATEXLexerToken {
    ...
    E_NOTATION_E = 120, LETTER_NO_E = 121, DIFFERENTIAL = 122, NUMBER = 123, 
    FRACTION_NUMBER = 124, SCI_NOTATION_NUMBER = 125, E_NOTATION = 126, 
    PERCENT_NUMBER = 127, GREEK_CMD = 128, SYMBOL = 129, VARIABLE = 130, 
    COMPLEX_NUMBER_POLAR_ANGLE = 131
};
...
static const char* LATEXLexerTokenStrings[] = {
    ...
    "E_NOTATION_E", "LETTER_NO_E", "DIFFERENTIAL", "NUMBER", 
