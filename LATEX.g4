...
fragment COMPLEX_NUMBER_POLAR_ANGLE_DEGREES: NUMBER DEGREE ' ';
fragment COMPLEX_NUMBER_RADIANS: NUMBER ((MUL | CMD_TIMES ' ' | CMD_CDOT ' ')? PI)?
...
fragment COMPLEX_NUMBER_POLAR_ANGLE_RADIANS: COMPLEX_NUMBER_RADIANS
    | COMPLEX_NUMBER_RADIAN_FRACTION
    | FRACTION_NUMBER PI;
COMPLEX_NUMBER_POLAR_ANGLE: ANGLE ' ' SUB? (COMPLEX_NUMBER_POLAR_ANGLE_DEGREES | COMPLEX_NUMBER_POLAR_ANGLE_RADIANS | VARIABLE);
